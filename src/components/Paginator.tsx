...
export default function Paginator(): ReactNode {
    ...
    if (mounted) {
        return (
            <footer
                className={`flex flex-col sticky sm:flex-row pt-2 px-5 gap-1 min-h-[65px] w-full bottom-0 z-20 align-top justify-center sm:justify-between bg-background border-solid border-t-small`}
            >
